...
describe("#hasCertainKey", function() {
  var arr = [
    { first: "Elie", last: "Scotts" },
    { first: "Tim", last: "Glads", isCatOwner: true },
    { first: "Kattie", last: "Lane" },
    { first: "Vanessa", last: "News", isCatOwner: true }
  ];
...
describe("#hasCertainValue", function() {
  var arr = [
    { title: "Instructor", first: "Elie", last: "Burger" },
    { title: "Instructor", first: "Tim", last: "Crane", isCatOwner: true },
    { title: "Instructor", first: "Matt", last: "Lane" },
    { title: "Instructor", first: "Vanessa", last: "People", isCatOwner: true }
  ];
